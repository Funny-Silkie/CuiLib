...
{
    [TestFixture]
    public class OrGroupOptionTest
    {
        private OrGroupOption option;
        ...
        public void SetUp()
        {
            ...
            option = new OrGroupOption(child1, child2);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new OrGroupOption(Array.Empty<Option>()));
        }
