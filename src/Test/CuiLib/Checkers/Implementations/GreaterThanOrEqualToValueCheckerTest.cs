...
{
    [TestFixture]
    public class GreaterThanOrEqualToValueCheckerTest : TestBase
    {
        private GreaterThanOrEqualToValueChecker<int> checker;

        [SetUp]
        public void SetUp()
        {
            checker = new GreaterThanOrEqualToValueChecker<int>(100, null);
        }
        ...
        {
            var checker = new GreaterThanOrEqualToValueChecker<int>(3, null);
        ...
        public void Ctor_WithSpecifiedComparer()
        {
            ...
            var checker = new GreaterThanOrEqualToValueChecker<int>(3, comparer);
