...
{
    [TestFixture]
    public class LessThanValueCheckerTest : TestBase
    {
        private LessThanValueChecker<int> checker;

        [SetUp]
        public void SetUp()
        {
            checker = new LessThanValueChecker<int>(100, null);
        }
        ...
        {
            var checker = new LessThanValueChecker<int>(3, null);
        ...
        public void Ctor_WithSpecifiedComparer()
        {
            ...
            var checker = new LessThanValueChecker<int>(3, comparer);
